...
public class Ysave extends JFrame implements ActionListener{
	JTextField tfMoney;
	...
	BufferedReader br;
	PrintWriter pw;
	public Ysave(BufferedReader br,PrintWriter pw,Card currCard){
		this.br=br;
		this.pw=pw;
	...
	public void init(){
		//添加取款页面卡片
				...
				JLabel lblqukuan = new JLabel("请输入您的存款数额：");
			...
			int saveMoney=Integer.parseInt(tfMoney.getText());
				...
				try {
					...
					if(strEcho.equals("Success")){
						...
						JOptionPane.showMessageDialog(Ysave.this, "取款成功");
					}else 
					{
						if(strEcho.equals("timeno"))
							JOptionPane.showConfirmDialog(Ysave.this, "","六个月还没有到，您是否真的要取款？",JOptionPane.YES_NO_OPTION);

						else
						JOptionPane.showMessageDialog(Ysave.this, "取款失败，请重试");
					}
				} catch (IOException e) {
